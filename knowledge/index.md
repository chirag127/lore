---
type: index
title: "oriz-lore-book-summaries-app — knowledge bundle"
description: "App-specific knowledge for oriz-lore-book-summaries-app. Cross-cutting family rules live at master `c:/D/oriz/knowledge/`."
tags: [okf, index, app, lore-book-summaries]
timestamp: 2026-06-21
format_version: okf-v0.1
status: active
---

# oriz-lore-book-summaries-app — knowledge bundle

This is the per-app OKF-light bundle for **oriz-lore-book-summaries-app**. App-specific facts only. Cross-cutting family rules / decisions / services live at master [`../../../../knowledge/`](../../../../knowledge/).
...
- **Category**: content
- **Family role**: Structured book summaries — overview, content, analysis, narration.

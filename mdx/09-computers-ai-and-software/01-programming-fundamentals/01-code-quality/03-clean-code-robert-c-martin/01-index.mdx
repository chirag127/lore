*Clean Code: A Handbook of Agile Software Craftsmanship* (2008) by Robert C. Martin is divided into principles, patterns, and practices of writing clean code with case studies. Covers meaningful names, small functions, comments, formatting, error handling, unit testing, and classes.

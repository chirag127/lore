...
*The Disappearing Spoon: And Other True Tales of Madness, Love, and the History of the World from the Periodic Table of the Elements* was published in 2010 and belongs to the tradition of Chemistry and Science. The work emerged from a specific historical moment and reflects the intellectual currents of its time.

### Author Background

Sam Kean brought unique perspective and expertise to this work. The author's background, training, and position shaped the arguments presented and the evidence selected.

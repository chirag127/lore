*Business Model Generation* (2010) by Alexander Osterwalder, Yves Pigneur is a handbook for visionaries designing tomorrow's enterprises using the Business Model Canvas framework, co-created by 470 practitioners.

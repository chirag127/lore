...
*Structure and Interpretation of Computer Programs* was published in 1996 and belongs to the tradition of Computer Science and Programming. The work emerged from a specific historical moment and reflects the intellectual currents of its time.

### Author Background

Harold Abelson, Gerald Jay Sussman brought unique perspective and expertise to this work. The author's background, training, and position shaped the arguments presented and the evidence selected.
